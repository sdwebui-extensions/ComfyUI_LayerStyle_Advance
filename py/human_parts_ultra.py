...
if not os.path.exists(model_path) and os.path.exists(os.path.join(folder_paths.cache_dir, "models/onnx")):
    model_path = os.path.join(folder_paths.cache_dir, "models/onnx/deeplabv3p-resnet50-human.onnx")
