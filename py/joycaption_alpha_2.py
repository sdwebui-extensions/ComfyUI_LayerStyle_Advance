...
def load_models(model_path, dtype, vlm_lora, device):
    ...
    if not os.path.exists(CHECKPOINT_PATH) and os.path.exists(os.path.join(folder_paths.cache_dir, "models/Joy_caption/cgrkzexw-599808")):
    ...
    if not os.path.exists(LORA_PATH) and os.path.exists(os.path.join(folder_paths.cache_dir, "models/Joy_caption/text_model")):
        LORA_PATH = os.path.join(folder_paths.cache_dir, "models/Joy_caption/text_model")
