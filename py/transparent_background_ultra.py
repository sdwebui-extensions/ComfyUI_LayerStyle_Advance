...
def scan_model():
    model_file_list = glob.glob(os.path.join(folder_paths.models_dir, "transparent-background") + '/*.pth') + glob.glob('/stable-diffusion-cache/models/transparent-background' + '/*.pth')
    model_dict = {}
